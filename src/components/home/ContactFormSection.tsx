  ...
  <div className="grid lg:grid-cols-2 gap-12 items-center bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-[#2a3443]/10">
        ...
        <div className="p-8 sm:p-12">
          <form className="space-y-6">
            <div>
              ...
              <input type="text" id="name" name="name" placeholder="John Doe" 
                className="w-full px-4 py-3 border border-[#2a3443]/30 rounded-lg focus:ring-2 focus:ring-[#d10e22] focus:border-[#d10e22] transition duration-150" required 
              />
            </div>
            <div>
            ...
            <div>
              <label htmlFor="carDetails" className="block text-sm font-medium text-gray-700 mb-1">Car Details & Destination</label>
              <textarea id="carDetails" name="carDetails" rows={4} placeholder="Year, Make, Model, and target country..."
                className="w-full px-4 py-3 border border-[#2a3443]/30 rounded-lg focus:ring-2 focus:ring-[#d10e22] focus:border-[#d10e22] transition duration-150 resize-none" required
              ></textarea>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 mb-3">...or connect instantly via WhatsApp:</p>
