...
const Navigation = () => {
  ...
  <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center space-x-8 justify-center flex-1">
            ...
            <a href="https://www.pinnacleclassics.com" target="_blank" rel="noopener noreferrer" className="text-[#3185AA] hover:text-[#266d8a] transition-quick font-medium">
              Classics
            </a>
    ...
    {isOpen && (
      ...
      >
        <div className="bg-white rounded-b-2xl border-b-2 border-[#e6e6e6] w-full max-w-full shadow-2xl flex flex-col items-center px-2 pt-8 pb-3 space-y-1">
          ...
          <a href="https://www.pinnacleclassics.com" target="_blank" rel="noopener noreferrer" className="block px-3 py-2 text-[#3185AA] hover:text-[#266d8a] transition-quick font-medium" onClick={() => setIsOpen(false)}>Classics</a>
